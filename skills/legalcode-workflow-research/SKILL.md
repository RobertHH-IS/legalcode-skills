...
**Hard Gate for legal work** - You MUST additionally get answers to: 5. **What jurisdiction(s) apply?** (Governing law, forum, enforcement jurisdiction) 6. **What is the governing law?** (Contractual choice-of-law, statutory regime, regulatory body) 7. **Are there applicable regulations?** (Industry-specific, cross-border, sector regulations) 8. **Are there privilege concerns?** (Attorney-client privilege, work product, litigation hold) 9. **Have conflict checks been completed?** (Parties, related entities, adverse interests) 10. **What is the matter timeline?** (Statutes of limitation, filing deadlines, contractual deadlines, court dates)
